...
/**
 * 업적 목 (V14) — be-api-guide-0914 §8 **21종**.
 * 코드·분류·정렬은 명세 그대로, 이름·설명 문구는 시안(V14_업적_1/2/3) 그대로다.
 * 획득 여부는 화면 확인용으로 섞어 두었다(컬러/흑백 배지가 함께 보이도록).
 * ⚠️ 아이콘 경로는 **서버 절대경로** 형태로 둔다 — 리포지토리가 API base를 붙인다.
 */
export const mockAchievements: Achievement[] = [
  ...
  },
  {
    ...
    sortOrder: 20,
    name: '군산 런트립 정복자',
    description: '군산의 모든 추천코스를 완주했다.',
    iconOnUrl: '/images/achievements/gunsan_conqueror_on.webp',
    iconOffUrl: '/images/achievements/gunsan_conqueror_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
  ...
  },
  {
    ...
    sortOrder: 40,
    name: '군산 초보 러너',
    description: '군산의 러닝코스를 즐겨봤다.',
    iconOnUrl: '/images/achievements/gunsan_beginner_on.webp',
    iconOffUrl: '/images/achievements/gunsan_beginner_off.webp',
    unlocked: true,
    unlockedAt: '2026-08-01T10:12:00Z',
  },
  {
    ...
    sortOrder: 50,
    name: '자연을 사랑해!',
    description: '군산의 편백나무 숲 코스를 완주했다.',
    iconOnUrl: '/images/achievements/nature_lover_on.webp',
    iconOffUrl: '/images/achievements/nature_lover_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 60,
    name: '부숴지는 파도들 사이에서',
    description: '군산의 새만금 방파제 코스를 완주했다.',
    iconOnUrl: '/images/achievements/between_waves_on.webp',
    iconOffUrl: '/images/achievements/between_waves_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 70,
    name: '천변벚꽃',
    description: '삼천변 벚꽃길 방문',
    iconOnUrl: '/images/achievements/jeonju_cherry_blossom_on.webp',
    iconOffUrl: '/images/achievements/jeonju_cherry_blossom_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
  ...
  },
  {
    ...
    sortOrder: 90,
    name: '덕진 호수',
    description: '덕진호수의 연꽃들 관람',
    iconOnUrl: '/images/achievements/jeonju_deokjin_lake_on.webp',
    iconOffUrl: '/images/achievements/jeonju_deokjin_lake_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 100,
    name: '전주 런트립 정복자',
    description: '전주의 모든 추천코스를 완주했다.',
    iconOnUrl: '/images/achievements/jeonju_conqueror_on.webp',
    iconOffUrl: '/images/achievements/jeonju_conqueror_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 110,
    name: '전주 성지순례자',
    description: '전주의 천주교 성지 코스를 완주했다.',
    iconOnUrl: '/images/achievements/jeonju_pilgrim_on.webp',
    iconOffUrl: '/images/achievements/jeonju_pilgrim_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 120,
    name: '전주 자연생태관',
    description: '전주 자연생태관 방문',
    iconOnUrl: '/images/achievements/jeonju_eco_museum_on.webp',
    iconOffUrl: '/images/achievements/jeonju_eco_museum_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 130,
    name: '장기간 러닝 성공',
    description: '3시간 넘게 런트립',
    iconOnUrl: '/images/achievements/long_run_3h_on.webp',
    iconOffUrl: '/images/achievements/long_run_3h_off.webp',
    unlocked: true,
    unlockedAt: '2026-08-01T10:12:00Z',
  },
  {
    ...
    name: '완주 10회 달성',
    description: '완주 10회',
    iconOnUrl: '/images/achievements/finish_10_on.webp',
    iconOffUrl: '/images/achievements/finish_10_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 150,
    name: '아이스크림 러너',
    description: '12월 중 런트립 완주',
    iconOnUrl: '/images/achievements/ice_cream_runner_on.webp',
    iconOffUrl: '/images/achievements/ice_cream_runner_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    name: '100km 이상',
    description: '누적거리 달성',
    iconOnUrl: '/images/achievements/distance_100km_on.webp',
    iconOffUrl: '/images/achievements/distance_100km_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 170,
    name: '얼리버드',
    description: '아침 8시 이전에 런트립 시작',
    iconOnUrl: '/images/achievements/early_bird_on.webp',
    iconOffUrl: '/images/achievements/early_bird_off.webp',
    unlocked: true,
    unlockedAt: '2026-08-01T10:12:00Z',
  },
  {
    ...
    sortOrder: 180,
    name: '경유지 3개 지나감',
    description: '졍유지 3개 거침',
    iconOnUrl: '/images/achievements/waypoint_3_on.webp',
    iconOffUrl: '/images/achievements/waypoint_3_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
    ...
    sortOrder: 190,
    name: '휴식타임',
    description: '카페, 음식점을 도착지로 설정하고 러닝 완주',
    iconOnUrl: '/images/achievements/rest_time_on.webp',
    iconOffUrl: '/images/achievements/rest_time_off.webp',
    unlocked: false,
    unlockedAt: null,
  },
  {
